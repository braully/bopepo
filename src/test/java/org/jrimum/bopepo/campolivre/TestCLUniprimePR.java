...
/**
 * <p>
 * Teste unitário do campo livre Uniprime Norte do Parana.
 * </p>
 *
 * @author jdalfre
 *
 ...
 * @version 0.2
 */
public class TestCLUniprimePR extends AbstractCampoLivreBaseTest<CLUniprime> {
	...
	public void setUp(){
		...
		titulo.getContaBancaria().setBanco(BancosSuportados.UNIPRIMEPR.create());
