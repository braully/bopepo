...
public class Boleto {
    ...
    protected static Logger log = LogManager.getLogger(Boleto.class);
     ...
     *
     * @param campo Nome do campo no template
     * @param conteudo Texto a ser adicionado ao campo no template
     */
     ...
     *
     * @param textosExtras Campos atribuídos
     */
     ...
     * Substitui todos os campos extra da instância caso exista.
     *
     * @param imagensExtras Campos atribuídos
     */
     ...
     *
     * @param campo Nome do campo no template
     * @param conteudo Imagem a ser adicionada ao campo no template
     */
