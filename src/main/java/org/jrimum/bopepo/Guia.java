...
/**
 * <p>
 * É a representação do documento Guia que por sua vez, representa um meio para
...
public final class Guia {
    ...
    private static Logger log = LogManager.getLogger(Guia.class);
    ...
    public Guia(Arrecadacao arrecadacao) throws IllegalArgumentException,
        ...
        try {
            ...
            Objects.checkNotNull(arrecadacao.getOrgaoRecebedor().getTipoSeguimento());
        } catch (Exception e) {
