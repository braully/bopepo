...
import org.jrimum.bopepo.parametro.ParametroDaycoval;
 ...
 * @version 0.2
 */
class CLDaycoval extends AbstractCLDaycoval {
	...
	protected void checkValues(Titulo titulo){
		...
		checkParametroBancario(titulo, ParametroDaycoval.OPERACAO);
		checkParametroBancarioMenorOuIgualQue(titulo, ParametroDaycoval.OPERACAO, 9999999);
	...
	protected void addFields(Titulo titulo) {
		...
		this.add(new FixedField<Integer>(titulo.getParametrosBancarios().<Integer>getValor(ParametroDaycoval.OPERACAO), OPERACAO_LENGHT, Fillers.ZERO_LEFT));
