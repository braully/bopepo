...
import org.jrimum.bopepo.parametro.ParametroABCBrasil;
...
/**
 * <p>
 * O campo livre do ABC Brasil deve seguir esta forma:
 * </p>
 *
 ...
 * <td >01 - 04</td>
 * <td >4</td>
 * <td >Código da Agência (Sem DV)</td>
 ...
 * @version 0.2
 */
class CLABCBrasil extends AbstractCLABCBrasil {
	...
	/**
	 * Tamanho do campo Código da Agência = 4.
	 */
	private static final Integer AGENCIA_LENGTH = Integer.valueOf(4);

	/**
	 * Tamanho do campo Número da Carteira do Título = 3.
	 */
	...
	protected void addFields(Titulo titulo) {
		...
		this.add(new FixedField<Integer>(titulo.getCarteira(), NUMERO_CARTEIRA_TITULO_LENGHT, Fillers.ZERO_LEFT));
