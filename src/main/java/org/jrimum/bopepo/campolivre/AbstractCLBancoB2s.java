...
/**
 * <p>
 * Interface comum para todos os campos livres do Banco B2S que.
 * venham a existir.
 * </p>
 *
 * @author jdalfre
 ...
 * @version 0.2
 */
public abstract class AbstractCLBancoB2s extends AbstractCampoLivre {

	/**
	 *
	 */
	private static final long serialVersionUID = 7217219748284715083L;


	protected AbstractCLBancoB2s(Integer fieldsLength) {
		super(fieldsLength);
	}

	protected static CampoLivre create(Titulo titulo){
		return new CLBancoB2s().build(titulo);
	}
