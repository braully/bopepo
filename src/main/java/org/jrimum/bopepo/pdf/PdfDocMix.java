...
public class PdfDocMix {
	...
	/**
	 * Retorna um {@code Map} com os campos e seus respectivos textos adicionados
	 * nessa instância.
	 *
	...
	/**
	 * Coloca um par {@code key,value} para uso no preenchimento de campos de Texto
	 * na instância.
	 *
	...
	/**
	 * Retorna um {@code Map} com os campos e suas respectivas imagens adicionadas
	 * nessa instância.
	 *
	...
	/**
	 * Coloca um par {@code key,value} para uso no preenchimento de campos de Imagem
	 * na instância.
	 *
	 * @param name  Nome do campo
	 ...
	 *
	 * @param destPath Caminho completo do arquivo o qual o documento será gerado
	...
	public ByteArrayOutputStream toStream() {
		...
		try {
			...
			return Exceptions.throwIllegalStateException(
					"Erro durante a criação do stream! " + "Causado por " + e.getLocalizedMessage(), e);
		}
	}
	...
	public byte[] toBytes() {
		...
		try {
			...
			return Exceptions.throwIllegalStateException(
					"Erro durante a criação do array de bytes! " + "Causado por " + e.getLocalizedMessage(), e);
		}
	}
	...
	/**
	 * Indica se o viewer foi habilitado para remover todos os campos do pdf gerado.
	 *
	 * @see #removeFields
	 *
	 * @return indicativo de compressão
	...
	private void end() {
		/*
		 * if (isFullCompression()) { try { stamper.setFullCompression(); } catch
		 * (DocumentException ex) { throw new RuntimeException(ex); } }
		 */
