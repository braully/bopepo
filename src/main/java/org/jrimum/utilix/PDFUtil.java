...
public class PDFUtil {
	...
	protected static final Logger LOG = LogManager.getLogger(PDFUtil.class);

	public static RectanglePDF changeField2Image(PdfStamper stamper, float[] positions, Image image)
	...
	public static RectanglePDF changeField2Image(PdfStamper stamper, RectanglePDF rect, Image image)
			throws DocumentException {
